...
//            		Log.e("Status", "receive a wireless state change : " + state +"!!");
//            		switch (state) {
//            		case CONNECTING:
//    				case CONNECTED:
//    					for (Preference mpref : prefs) {
//    						getPreferenceScreen().addPreference(mpref);
//						}    					
//    					break;
//
//    				default:
...
//    					break;
//            		}
            		if(mTelephonyManager.getSimOperator().length() != 0){
            			for (Preference mpref : prefs) {
    						getPreferenceScreen().addPreference(mpref);
						} 
					}else{
