...
//					case CONNECTED:
//						if(mSimLock != null){
//							getPreferenceScreen().addPreference(mSimLock);				
//						}			
//						break;
//
//					default:
//						if(mSimLock != null){
//							getPreferenceScreen().removePreference(mSimLock);
//						}	        									
//						break;
//					}
	        		if(tm.getSimOperator().length() != 0){
						if(mSimLock != null){
							getPreferenceScreen().addPreference(mSimLock);				
						}
					}else{
    ...
    private PreferenceScreen createPreferenceHierarchy() {
		...
		if(disableLockScreenForever == false)
        ...
        mSimLock = root.findPreference(KEY_SIM_LOCK);
    ...
    public void onResume() {
        ...
        getActivity().registerReceiver(mSimStateReceiver, 
